    ...
    <aside class="left-sidebar" data-sidebarbg="skin6">
        ...
        <div class="scroll-sidebar" data-sidebarbg="skin6">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link active" href="index.html"
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Create New Lot</h3>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle">Items in Lot</h6>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        <input type="date" class="form-control" value="2021-03-28">
                                    </div>

                                    <h6 class="card-subtitle">Producer</h6>
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2">
                                            <option>
                                                Select Profile
