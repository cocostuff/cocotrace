                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form:form method="POST" modelAttribute="product" action="/addProduct">
                                        ...
                                        <h6 class="card-subtitle">Manufacturing Origin</h6>
                                        <div class="form-group mb-4">
                                            <form:input  class="form-control" path="manufacturingOrigin"/>
                                        </div>

                                        <h6 class="card-subtitle">Manufacturing Date</h6>
                                        <div class="form-group mb-4">
                                            <form:input type="date" class="form-control" path="manufacturingDateString" />
                                        </div>

                                        <h6 class="card-subtitle">Consumed Before</h6>
                                        <div class="form-group mb-4">
                                            <form:input type="date" class="form-control" path="consumedBeforeString" />
                                        </div>

                                        <h6 class="card-subtitle">Weight</h6>
                                        <div class="form-group mb-4">
                                            <form:input  class="form-control" path="weight"/>
                                        </div>

                                        <input class="button-update-sc btn btn-info" type="submit" value="Add Product" />
