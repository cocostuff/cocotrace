...
insert into user_account (active, email, password, username, role_id) values (true, 'test@test.com', '$2a$10$otMn8Xre2SYZm.cZwa4q8e7hq3Y7/gkGoD9FOMvVmRvPr75p3POLm', 'admin', 1);
